                ...
                switch (choice)
                {
                    case 1:
                        ...
                        if (signUpChoice == 1 || signUpChoice == 2) {
                            ...
                            switch (signUpChoice) {
                                case 1:
                                     db.RegisterPetSitter(newName, newSurname, newEmail, newPassword, newLocation);//TODO:for sign up as a pet sitter
                                    break;
                                case 2:
                                    db.RegisterPetOwner(newName, newSurname, newEmail, newPassword, newLocation); //TODO:for sign up as a pet owner
                                    break;
                            }
                        } else 
